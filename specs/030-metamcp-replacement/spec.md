...
- `agentgateway.genai.127.0.0.1.nip.io` → MCP proxy listener
...
1. `curl agentgateway.genai.127.0.0.1.nip.io/mcp -d '{"jsonrpc":"2.0","method":"tools/list","id":1}'` → returns tools from all backends
